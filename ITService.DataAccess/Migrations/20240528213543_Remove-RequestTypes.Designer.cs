...
namespace ITService.DataAccess.Migrations
{
    ...
    [Migration("20240528213543_Remove-RequestTypes")]
    partial class RemoveRequestTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITService.Model.User", b =>
                {
                    b.HasOne("ITService.Model.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId");

                    b.HasOne("ITService.Model.Employee", "Employee")
                        .WithMany()
